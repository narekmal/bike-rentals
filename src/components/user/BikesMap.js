...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)( class BikesMap extends Component {
  ...
  render() {
    let bikeIcons;
    if(this.props.bikes)
      bikeIcons = this.props.bikes.map((b,i)=><BikeIcon key={i} lat={b.latitude} lng={b.longitude} bikeId={b.id} />)
    return (
...
//           width="45px" fill={this.props.selected ? 'green' : 'black'} viewBox="0 0 263.345 263.345" xmlSpace="preserve">
//           <g>
//             <g>
